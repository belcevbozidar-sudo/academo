...
export default function EditSubjectForm({ subjectId, onSuccess }: EditSubjectFormProps) {
  ...
  useEffect(() => {
    if (currentSubject) {
      setFormData({
        ...
        isPrimary: currentSubject.isPrimary || false,
        selectedTeachers: [],
      });
    }
  }, [currentSubject]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Предметът е актуализиран успешно");
      ...
      toast.error("Грешка при актуализиране на предмет");
    }
  };
