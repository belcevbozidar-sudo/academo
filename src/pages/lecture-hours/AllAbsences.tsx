...
function AllAbsencesInner() {
  ...
  const filteredAbsences = absences?.filter((absence) => {
    ...
    return (
      ...
      absence.absentTeacher.toLowerCase().includes(searchLower) ||
        ...
        <Card>
          <CardHeader className="border-b">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-xl">Всички учителски отсъствия</CardTitle>
            </div>
          </CardHeader>
...
export default function AllAbsences() {
  return (
    <>
      <Unauthenticated>
        <Layout>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center min-h-[400px] gap-4">
                <p className="text-muted-foreground">
                  Моля, влезте, за да видите всички отсъствия
                </p>
                <SignInButton />
              </CardContent>
            </Card>
